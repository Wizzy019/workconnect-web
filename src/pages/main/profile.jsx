        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="relative -mt-24 bg-white rounded-xl shadow-md p-6 sm:p-8 border border-gray-100">
            ...
            <div className="flex flex-col md:flex-row items-center md:items-start gap-6">
              ...
              <div className="flex-1 text-center md:text-left pt-2">
                <h1 className="text-3xl font-bold text-[#001e2b]">
                  {profile.name}
                </h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-6">
            <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
              <h2 className="text-lg font-bold text-[#001e2b] mb-4 border-b border-gray-100 pb-2">
                About Me
              </h2>
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center gap-3 text-sm">
                  ...
                  <span className="text-gray-700 font-medium">
                    Website:{" "}
                    <span className="text-[#1dbf73]">{profile.website}</span>
                  </span>
                </div>
                <div className="flex items-center gap-3 text-sm">
                  <FontAwesomeIcon
                  ...
                  <span className="text-gray-700 font-medium">
                    LinkedIn:{" "}
                    <span className="text-[#1dbf73]">{profile.linkedin}</span>
                  </span>
                </div>
              </div>
            </div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {profile.skills &&
                      profile.skills.map((skill) => (
                        <span
                          key={skill}
                          className="px-4 py-1.5 bg-[#f0f3f2] text-[#404145] rounded-full text-xs font-semibold border border-gray-100"
                        >
                          {skill}
                        </span>
                      ))}
