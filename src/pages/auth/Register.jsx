        ...
        {error && <p className="text-sm text-red-500 ">{error}</p>}
          ...
          {step === 2 && (
            <div className="animate-fadeIn">
              ...
              {formData.role === 'freelancer' && (
                <InputField label="Primary Skill" name="skill" value={formData.skill} onChange={handleChange} />
              )}
          ...
          {step === 3 && (
            <div className="animate-fadeIn">
              ...
              <div className="mb-4">
                <label className="block text-gray-700 text-sm font-bold mb-1">How did you hear about us?</label>
                <select name="source" value={formData.source} onChange={handleChange} className="w-full px-3 py-2 border rounded-lg">
              ...
              <div className="mb-4">
                <label className="block text-gray-700 text-sm font-bold mb-1">ID Type</label>
                <select name="idType" value={formData.idType} onChange={handleChange} className="w-full px-3 py-2 border rounded-lg">
          ...
          <div className="flex justify-between mt-8">
            ...
            {step < 3 && <button type='button' className="bg-green-700 text-white p-2 rounded" onClick={nextStep}>Next</button>}
            {step === 3 && <button type='submit'  className="bg-green-700 text-white p-2 rounded" >Register</button>}
          </div>
        </form>

        <div className="mt-6 text-center text-sm text-gray-500">
          Already registered?<Link to="/login"> <div  className='text-green-600 font-semibold'>Go to login</div></Link>
        </div>
      </div>
    </div>
  );
