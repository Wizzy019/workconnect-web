...
const EditProfileModal = ({ isOpen, onClose, initialData, onSaveSuccess, onError }) => {
      ...
      <div className="bg-white w-full max-w-lg rounded-2xl shadow-2xl overflow-hidden animate-in fade-in zoom-in duration-200">
        ...
        <div className="p-6 max-h-[70vh] overflow-y-auto space-y-5 custom-scrollbar">
          <div className="space-y-2">
            ...
            <div className="flex flex-wrap gap-2 mb-2">
              {formData.skills.map(skill => (
                <span key={skill} className="bg-gray-100 text-gray-700 px-3 py-1 rounded-md text-xs font-medium flex items-center gap-2 border border-gray-200">
                  {skill}
          ...
          <div className="space-y-1">
            <label className="text-sm font-bold text-[#001e2b]">Phone Number</label>
            <input 
              name="phone" value={formData.phoneNumber} onChange={handleInputChange}
          ...
          <div className="space-y-1">
            <label className="text-sm font-bold text-[#001e2b]">Availability</label>
            <select 
